...
$allowed_strains = ['ld_astephensi_salivary_scp_bento2025'];
$allowed_models  = ['ARS','JTK','LS','meta2d'];

if ($_SERVER["REQUEST_METHOD"] !== "POST") { header("Location: proteomics.php"); exit; }
...
$dataset_labels = [
    'ld_astephensi_salivary_scp_bento2025' => 'LD A. stephensi Salivary SCP (Bento et al., 2025)',
];
...
<div style="background:#f4f4f8; border-radius:8px; padding:12px 24px; margin:10px auto 20px; max-width:960px; font-size:14px; color:#444;">
    ...
    &nbsp;&nbsp; <a href="proteomics.php" style="color:#2c1e56; font-weight:bold;">← New Search</a>
</div>
...
function downloadTableCSV() {
    ...
    a.download = 'proteomics_rhythmicity_results.csv';
    a.click();
}
</script>

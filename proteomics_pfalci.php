...
<a href="P-ber.php" style="text-decoration: none;">
    ...
    <!-- Search Form -->
    <div class="card">
    <form action="proteomics_pfalci_result.php" method="POST" id="searchForm">

    <div class="card2">
    <div class="left-section" style="width:100%;">
        <h3>Search for Proteins</h3>
        <div class="search" style="width:100%;">
            <input type="text" name="genes" id="genes" required
                   ...
                   placeholder="Enter protein IDs, comma-separated (e.g., PFA0400c, PFB0340c)">
        </div>
        <div class="op" style="margin-top:10px;">
            <h6>Example Search:</h6>
            <input type="button" class="button button1" value="PFA0400c" onClick="appendItem('PFA0400c');">&emsp;
            <input type="button" class="button button1" value="PFB0340c" onClick="appendItem('PFB0340c');">&emsp;
            <input type="button" class="button button1" value="PFC0120w" onClick="appendItem('PFC0120w');">&emsp;
        </div>
    </div>
    </div>
...
.ds-dropdown-panel input[type="checkbox"] { accent-color:#5b3fa3; width:15px; height:15px; flex-shrink:0; }
        ...
        <div class="model-container" style="display:flex; align-items:center; margin-bottom:18px;">
            ...
            <div class="ds-dropdown-wrapper" id="dsWrapper_proteomics_pfalci">
                <button type="button" class="ds-dropdown-btn" id="dsBtn_proteomics_pfalci"
                        onclick="toggleDsDropdown('proteomics_pfalci')">— Select Dataset(s) —</button>
                <div class="ds-dropdown-panel" id="dsPanel_proteomics_pfalci">
                    <label class="select-all-row">
                        <input type="checkbox" id="chk_ds_all_proteomics_pfalci"
                               onchange="dsSelectAll('proteomics_pfalci', this.checked)"> Select All (1)
                    </label>
            <label><input type="checkbox" name="strain[]" value="dd2_pfalci_prot_foth2011"> DD2 P. falciparum Proteomics (Foth et al., 2011)</label>
                </div>
            </div>
        </div>
        <script>
        (function(){
            ...
            document.querySelectorAll('#dsPanel_proteomics_pfalci input[name="strain[]"]').forEach(cb => {
                cb.addEventListener('change', () => updateDsBtn('proteomics_pfalci'));
            });
            // Close dropdown when clicking outside
            document.addEventListener('click', function(e) {
                const wrap = document.getElementById('dsWrapper_proteomics_pfalci');
                if (wrap && !wrap.contains(e.target))
                    document.getElementById('dsPanel_proteomics_pfalci').classList.remove('open');
            });
            ...
            window._dsUpdateBtn_proteomics_pfalci = () => updateDsBtn('proteomics_pfalci');
        })();
        </script>

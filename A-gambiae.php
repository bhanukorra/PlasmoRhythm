...
.dropdown2-btn {
    ...
    border-radius: 5px;
    width: 200px; /* set as per your layout */
    white-space: nowrap;
    overflow: hidden;
...
<!-- <a href="A-gambiae.php" style="text-decoration: none;">
    ...
    <!-- Search Form -->
    <div class="card">
    <form action="A-gambiae_result.php" method="POST" id="geneForm">
    ...
    <div class="left-section" style="width:100%;">
        ...
        <div class="op" style="margin-top:10px;">
            ...
            <input type="button" class="button button1" value="AGAP000987" onClick="appendGene('AGAP000987')">&emsp;
            <input type="button" class="button button1" value="AGAP010434" onClick="appendGene('AGAP010434')">&emsp;
            <input type="button" class="button button1" value="AGAP011442" onClick="appendGene('AGAP011442')">&emsp;
        </div>
    </div>
    </div>
...
.ds-dropdown-panel input[type="checkbox"] { accent-color:#5b3fa3; width:15px; height:15px; flex-shrink:0; }
        ...
        <div class="model-container" style="display:flex; align-items:center; margin-bottom:18px;">
            ...
            <div class="ds-dropdown-wrapper" id="dsWrapper_A_gambiae">
                <button type="button" class="ds-dropdown-btn" id="dsBtn_A_gambiae"
                        onclick="toggleDsDropdown('A_gambiae')">— Select Dataset(s) —</button>
                <div class="ds-dropdown-panel" id="dsPanel_A_gambiae">
                    <label class="select-all-row">
                        <input type="checkbox" id="chk_ds_all_A_gambiae"
                               onchange="dsSelectAll('A_gambiae', this.checked)"> Select All (4)
                    </label>
            <label><input type="checkbox" name="strain[]" value="ld_agam_head_rund2011"> LD A. gambiae Head (Rund et al., 2011)</label>
            <label><input type="checkbox" name="strain[]" value="dd_agam_head_rund2011"> DD A. gambiae Head (Rund et al., 2011)</label>
            <label><input type="checkbox" name="strain[]" value="ld_agam_body_rund2011"> LD A. gambiae Body (Rund et al., 2011)</label>
            <label><input type="checkbox" name="strain[]" value="dd_agam_body_rund2011"> DD A. gambiae Body (Rund et al., 2011)</label>
                </div>
            </div>
        </div>
        <script>
        (function(){
            ...
            document.querySelectorAll('#dsPanel_A_gambiae input[name="strain[]"]').forEach(cb => {
                cb.addEventListener('change', () => updateDsBtn('A_gambiae'));
            });
            // Close dropdown when clicking outside
            document.addEventListener('click', function(e) {
                const wrap = document.getElementById('dsWrapper_A_gambiae');
                if (wrap && !wrap.contains(e.target))
                    document.getElementById('dsPanel_A_gambiae').classList.remove('open');
            });
            ...
            window._dsUpdateBtn_A_gambiae = () => updateDsBtn('A_gambiae');
        })();
        </script>

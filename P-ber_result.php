...
$allowed_strains = ['ld_pberghei_sporozoite_bento2025', 'dd_pberghei_sporozoite_bento2025'];
$allowed_models  = ['ARS','JTK','LS','meta2d'];

if ($_SERVER["REQUEST_METHOD"] !== "POST") { header("Location: P-ber.php"); exit; }
...
$dataset_labels = [
    'ld_pberghei_sporozoite_bento2025' => 'LD P. berghei Sporozoite (Bento et al., 2025)',
    'dd_pberghei_sporozoite_bento2025' => 'DD P. berghei Sporozoite (Bento et al., 2025)',
];
...
<div style="background:#f4f4f8; border-radius:8px; padding:12px 24px; margin:10px auto 20px; max-width:960px; font-size:14px; color:#444;">
    ...
    &nbsp;&nbsp; <a href="P-ber.php" style="color:#2c1e56; font-weight:bold;">← New Search</a>
</div>
...
function downloadTableCSV() {
    ...
    a.download = 'Pberghei_rhythmicity_results.csv';
    a.click();
}
</script>

...
<body class="index-page">
    ...
    <main class="main">
        ...
        $allowed_strains = ['dd_cry1cry2_ko_rijoferreira2020', 'dd_fbxl3_ko_rijoferreira2020', 'ld_matched_subudhi2020', 'dl_mismatched_subudhi2020', 'ld_nightfed_rijoferreira2020', 'ld_pchsr10_ko_subudhi2020', 'ld_pchwt_subudhi2020', 'ld_spreadout_rijoferreira2020', 'wtdd_adlib_ctrl_rijoferreira2020', 'wtdd_adlib_rijoferreira2020', 'wtld_adlib_rijoferreira2020'];
        $allowed_models = ['ARS', 'JTK', 'LS', 'meta2d'];

        if ($_SERVER["REQUEST_METHOD"] !== "POST") {
            header("Location: P-chaubaudi.php");
            exit;
        }
        ...
        $dataset_labels = [
            'dd_cry1cry2_ko_rijoferreira2020' => 'DD cry1/cry2 KO (Rijo-Ferreira et al., 2020)',
            'dd_fbxl3_ko_rijoferreira2020' => 'DD fbxl3 KO (Rijo-Ferreira et al., 2020)',
            'ld_matched_subudhi2020' => 'LD Matched (Subudhi et al., 2020)',
            'dl_mismatched_subudhi2020' => 'DL Mismatched (Subudhi et al., 2020)',
            'ld_nightfed_rijoferreira2020' => 'LD Night-fed (Rijo-Ferreira et al., 2020)',
            'ld_pchsr10_ko_subudhi2020' => 'LD PcHSR10 KO (Subudhi et al., 2020)',
            'ld_pchwt_subudhi2020' => 'LD PcHWT (Subudhi et al., 2020)',
            'ld_spreadout_rijoferreira2020' => 'LD Spread-out (Rijo-Ferreira et al., 2020)',
            'wtdd_adlib_ctrl_rijoferreira2020' => 'WT DD Ad Lib Control (Rijo-Ferreira et al., 2020)',
            'wtdd_adlib_rijoferreira2020' => 'WT DD Ad Lib (Rijo-Ferreira et al., 2020)',
            'wtld_adlib_rijoferreira2020' => 'WT LD Ad Lib (Rijo-Ferreira et al., 2020)',
        ];
...
foreach ($strain_list as $strain) {
        ...
        <div
            ...
            &nbsp;&nbsp; <a href="P-chaubaudi.php" style="color:#2c1e56; font-weight:bold;">← New Search</a>
        </div>
    ...
    <script>
        ...
        function downloadTableCSV() {
            ...
            a.download = 'Pchaubaudi_rhythmicity_results.csv';
            a.click();
        }
    </script>

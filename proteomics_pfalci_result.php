...
$allowed_strains = ['dd2_pfalci_prot_foth2011'];
$allowed_models  = ['ARS','JTK','LS','meta2d'];

if ($_SERVER["REQUEST_METHOD"] !== "POST") { header("Location: proteomics_pfalci.php"); exit; }
...
$dataset_labels = [
    'dd2_pfalci_prot_foth2011' => 'DD2 P. falciparum Proteomics (Foth et al., 2011)',
];
...
<div style="background:#f4f4f8; border-radius:8px; padding:12px 24px; margin:10px auto 20px; max-width:960px; font-size:14px; color:#444;">
    ...
    &nbsp;&nbsp; <a href="proteomics_pfalci.php" style="color:#2c1e56; font-weight:bold;">← New Search</a>
</div>
...
function downloadTableCSV() {
    ...
    a.download = 'proteomics_pfalci_rhythmicity_results.csv';
    a.click();
}
</script>

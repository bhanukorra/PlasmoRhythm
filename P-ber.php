...
<body class="index-page">
    ...
    <main class="main">
        ...
        <!-- Search Form -->
        <div class="card">
            <form action="P-ber_result.php" method="POST" id="geneForm">
                ...
                <div class="card2">
                    <div class="left-section" style="width:100%;">
                        ...
                        <div class="op" style="margin-top:10px;">
                            ...
                            <input type="button" class="button button1" value="PBANKA_0605300"
                                onClick="appendGene('PBANKA_0605300')">&emsp;
                            <input type="button" class="button button1" value="PBANKA_1358300"
                                onClick="appendGene('PBANKA_1358300')">&emsp;
                            <input type="button" class="button button1" value="PBANKA_0917200"
                                onClick="appendGene('PBANKA_0917200')">&emsp;
                        </div>
                    </div>
                </div>
                ...
                <div class="card3">
                    <div class="right-section">
                        ...
                        <div class="model-container" style="display:flex; align-items:center; margin-bottom:18px;">
                            ...
                            <div class="ds-dropdown-wrapper" id="dsWrapper_P_ber">
                                <button type="button" class="ds-dropdown-btn" id="dsBtn_P_ber"
                                    onclick="toggleDsDropdown('P_ber')">— Select Dataset(s) —</button>
                                <div class="ds-dropdown-panel" id="dsPanel_P_ber">
                                    <label class="select-all-row">
                                        <input type="checkbox" id="chk_ds_all_P_ber"
                                            onchange="dsSelectAll('P_ber', this.checked)"> Select All (2)
                                    </label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ld_pberghei_sporozoite_bento2025"> LD P. berghei (Bento et al.,
                                        2025)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="dd_pberghei_sporozoite_bento2025"> DD P. berghei (Bento et al.,
                                        2025)</label>
                        ...
                        <script>
                            (function () {
                                ...
                                document.querySelectorAll('#dsPanel_P_ber input[name="strain[]"]').forEach(cb => {
                                    cb.addEventListener('change', () => updateDsBtn('P_ber'));
                                });
                                // Close dropdown when clicking outside
                                document.addEventListener('click', function (e) {
                                    const wrap = document.getElementById('dsWrapper_P_ber');
                                    if (wrap && !wrap.contains(e.target))
                                        document.getElementById('dsPanel_P_ber').classList.remove('open');
                                });
                                ...
                                window._dsUpdateBtn_P_ber = () => updateDsBtn('P_ber');
                            })();
                        </script>

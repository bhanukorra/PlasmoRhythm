...
<a href="P-ber.php" style="text-decoration: none;">
    ...
    <!-- Search Form -->
    <div class="card">
    <form action="proteomics_result.php" method="POST" id="searchForm">
    ...
    <div class="left-section" style="width:100%;">
        ...
        <div class="search" style="width:100%;">
            <input type="text" name="genes" id="genes" required
                   ...
                   placeholder="Enter protein IDs, comma-separated (e.g., ASTE011657, ASTE005735)">
        </div>
        <div class="op" style="margin-top:10px;">
            <h6>Example Search:</h6>
            <input type="button" class="button button1" value="ASTE011657" onClick="appendItem('ASTE011657');">&emsp;
            <input type="button" class="button button1" value="ASTE005735" onClick="appendItem('ASTE005735');">&emsp;
            <input type="button" class="button button1" value="ASTE000825" onClick="appendItem('ASTE000825');">&emsp;
        </div>
    </div>
    </div>
...
.ds-dropdown-panel input[type="checkbox"] { accent-color:#5b3fa3; width:15px; height:15px; flex-shrink:0; }
        ...
        <div class="model-container" style="display:flex; align-items:center; margin-bottom:18px;">
            ...
            <div class="ds-dropdown-wrapper" id="dsWrapper_proteomics">
                <button type="button" class="ds-dropdown-btn" id="dsBtn_proteomics"
                        onclick="toggleDsDropdown('proteomics')">— Select Dataset(s) —</button>
                <div class="ds-dropdown-panel" id="dsPanel_proteomics">
                    <label class="select-all-row">
                        <input type="checkbox" id="chk_ds_all_proteomics"
                               onchange="dsSelectAll('proteomics', this.checked)"> Select All (1)
                    </label>
            <label><input type="checkbox" name="strain[]" value="ld_astephensi_salivary_scp_bento2025"> LD A. stephensi Salivary SCP (Bento et al., 2025)</label>
                </div>
            </div>
        </div>
        <script>
        (function(){
            ...
            document.querySelectorAll('#dsPanel_proteomics input[name="strain[]"]').forEach(cb => {
                cb.addEventListener('change', () => updateDsBtn('proteomics'));
            });
            // Close dropdown when clicking outside
            document.addEventListener('click', function(e) {
                const wrap = document.getElementById('dsWrapper_proteomics');
                if (wrap && !wrap.contains(e.target))
                    document.getElementById('dsPanel_proteomics').classList.remove('open');
            });
            ...
            window._dsUpdateBtn_proteomics = () => updateDsBtn('proteomics');
        })();
        </script>

...
<a href="A-steph.php" style="text-decoration: none;">
 ...
 <a href="A-gambiae.php" style="text-decoration: none;">
    ...
    <!-- Search Form -->
    <div class="card">
    <form action="A-steph_result.php" method="POST" id="geneForm">
    ...
    <div class="left-section" style="width:100%;">
        ...
        <div class="search" style="width:100%;">
            <input type="text" name="genes" id="genes" required
                   ...
                   placeholder="Enter gene IDs, comma-separated (e.g., ASTE006318, ASTE009880)">
        </div>
        <div class="op" style="margin-top:10px;">
            <h6>Example Search:</h6>
            <input type="button" class="button button1" value="ASTE006318" onClick="appendGene('ASTE006318');">&emsp;
            <input type="button" class="button button1" value="ASTE009880" onClick="appendGene('ASTE009880');">&emsp;
            <input type="button" class="button button1" value="ASTE008614" onClick="appendGene('ASTE008614');">
        </div>
    </div>
    </div>
...
.ds-dropdown-panel input[type="checkbox"] { accent-color:#5b3fa3; width:15px; height:15px; flex-shrink:0; }
        ...
        <div class="model-container" style="display:flex; align-items:center; margin-bottom:18px;">
            ...
            <div class="ds-dropdown-wrapper" id="dsWrapper_A_steph">
                <button type="button" class="ds-dropdown-btn" id="dsBtn_A_steph"
                        onclick="toggleDsDropdown('A_steph')">— Select Dataset(s) —</button>
                <div class="ds-dropdown-panel" id="dsPanel_A_steph">
                    <label class="select-all-row">
                        <input type="checkbox" id="chk_ds_all_A_steph"
                               onchange="dsSelectAll('A_steph', this.checked)"> Select All (2)
                    </label>
            <label><input type="checkbox" name="strain[]" value="ld_astephensi_rund2016"> LD A. stephensi (Rund et al., 2016)</label>
            <label><input type="checkbox" name="strain[]" value="dd_astephensi_rund2016"> DD A. stephensi (Rund et al., 2016)</label>
                </div>
            </div>
        </div>
        <script>
        (function(){
            ...
            document.querySelectorAll('#dsPanel_A_steph input[name="strain[]"]').forEach(cb => {
                cb.addEventListener('change', () => updateDsBtn('A_steph'));
            });
            // Close dropdown when clicking outside
            document.addEventListener('click', function(e) {
                const wrap = document.getElementById('dsWrapper_A_steph');
                if (wrap && !wrap.contains(e.target))
                    document.getElementById('dsPanel_A_steph').classList.remove('open');
            });
            ...
            window._dsUpdateBtn_A_steph = () => updateDsBtn('A_steph');
        })();
        </script>

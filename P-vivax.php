...
<body class="index-page">
    ...
    <main class="main">
        ...
        <!-- Search Form -->
        <div class="card">
            <form action="P-vivax_result.php" method="POST" id="geneForm">
                ...
                <div class="card2">
                    <div class="left-section" style="width:100%;">
                        ...
                        <div class="op" style="margin-top:10px;">
                            ...
                            <input type="button" class="button button1" value="PVP01_0205500"
                                onClick="appendGene('PVP01_0205500')">&emsp;
                            <input type="button" class="button button1" value="PVP01_0920200"
                                onClick="appendGene('PVP01_0920200')">&emsp;
                            <input type="button" class="button button1" value="PVP01_0530700"
                                onClick="appendGene('PVP01_0530700')">&emsp;
                        </div>
                    </div>
                </div>
                ...
                <div class="card3">
                    <div class="right-section">
                        ...
                        <div class="model-container" style="display:flex; align-items:center; margin-bottom:18px;">
                            ...
                            <div class="ds-dropdown-wrapper" id="dsWrapper_P_vivax">
                                <button type="button" class="ds-dropdown-btn" id="dsBtn_P_vivax"
                                    onclick="toggleDsDropdown('P_vivax')">— Select Dataset(s) —</button>
                                <div class="ds-dropdown-panel" id="dsPanel_P_vivax">
                                    <label class="select-all-row">
                                        <input type="checkbox" id="chk_ds_all_P_vivax"
                                            onchange="dsSelectAll('P_vivax', this.checked)"> Select All (13)
                                    </label>
                                    ...
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_02"> Ex vivo P. vivax Patient 02
                                        (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_08"> Ex vivo P. vivax Patient 08
                                        (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_09"> Ex vivo P. vivax Patient 09
                                        (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_10"> Ex vivo P. vivax Patient 10
                                        (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_11"> Ex vivo P. vivax Patient 11
                                        (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_13"> Ex vivo P. vivax Patient 13
                                        (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_16"> Ex vivo P. vivax Patient 16
                                        (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_17"> Ex vivo P. vivax Patient 17
                                        (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_19"> Ex vivo P. vivax Patient 19
                                        (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]"
                                            value="ex_vivo_pvivax_motta2023_parasite_avg_expres"> Ex vivo P. vivax
                                        Average Expression (Motta et al., 2023)</label>
                                    <label><input type="checkbox" name="strain[]" value="smru1_pvivax_bozdech_2008">SmRU
                                        1 P. vivax (Bozdech et al., 2008)</label>
                                    <label><input type="checkbox" name="strain[]" value="smru2_pvivax_bozdech_2008">SmRU
                                        2 P. vivax (Bozdech et al., 2008)</label>
                                    <label><input type="checkbox" name="strain[]" value="smru3_pvivax_bozdech_2008">SmRU
                                        3 P. vivax (Bozdech et al., 2008)</label>
                        ...
                        <script>
                            (function () {
                                ...
                                document.querySelectorAll('#dsPanel_P_vivax input[name="strain[]"]').forEach(cb => {
                                    cb.addEventListener('change', () => updateDsBtn('P_vivax'));
                                });
                                // Close dropdown when clicking outside
                                document.addEventListener('click', function (e) {
                                    const wrap = document.getElementById('dsWrapper_P_vivax');
                                    if (wrap && !wrap.contains(e.target))
                                        document.getElementById('dsPanel_P_vivax').classList.remove('open');
                                });
                                ...
                                window._dsUpdateBtn_P_vivax = () => updateDsBtn('P_vivax');
                            })();
                        </script>
